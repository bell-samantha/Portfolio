...
cat("THIS SHOULD BE EMPTY IF ALL DUPLICATES WERE REMOVED")
dups2
...
write.xlsx(zipPopTable, paste0(location, "/For internal Tableau reporting/", "Zip_Rates.xlsx")) 
write.xlsx(zipPopTable, paste0(outputLocation, "/", Sys.Date(), "_Full Zip_Rates.xlsx")) 
